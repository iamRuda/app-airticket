    ...
    MDBoxLayout:
        ...
        MDTopAppBar:
            ...
            right_action_items:
                ...
                ["ticket-confirmation", lambda x: x, "Мои билеты", "My tickets"],
...
class User():
    ...
    info = {'ID': ['53526262', 'identifier'], 'Логин': ['firstclient', 'login'], 'Электронная почта': ['rudfireman@gmail.com', 'email'],
            'ФИО': ['Рудченко Андрей Сергеевич', 'account'], 'Дата регистрации': ['2022/06/11', 'calendar-account'], 'Количество милей': ['1200', 'airplane']}
...
class LoginScreen(Screen):
    def checkAccount(self):
        request = {"type_request": "authorization", "login": self.ids.textfield_login.ids.text_field.text, "password": self.ids.textfield_login.ids.text_field.text}
            ...
            self.ids.rv.data.append(
                {
                    ...
                    "on_press": lambda *args: self.new_dialog(),
                }
            )
...
class SettingsScreen(Screen):
    data_settings = {'switch_theme': {'viewclass': 'CustomListItemWithCheckbox', 'text': 'Включить темную тему', 'text_color': 'black', 'icon': 'theme-light-dark'},
                     'quit_account': {'viewclass': 'CustomListItem', 'text': 'Выйти из аккаунта', 'text_color': 'black', 'icon': 'account-arrow-left'},
                     'del_account': {'viewclass': 'CustomListItem', 'text': 'Удалить аккаунт', 'text_color': 'red', 'icon': 'account-remove'}}
